const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2022-05-21', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://gpt123.eu.org'},
  ...
  HEO_HERO_TITLE_3: 'GPT123.EU.ORG',
  HEO_HERO_TITLE_4: '新版上线',
  HEO_HERO_TITLE_5: '全新UI',
  HEO_HERO_TITLE_LINK: 'https://gpt123.eu.org',

  // 英雄区显示三个置顶分类
  HEO_HERO_CATEGORY_1: { title: '实用教程', url: '/category/GitHub项目' },
  HEO_HERO_CATEGORY_2: { title: '实用工具', url: '/tag/实用工具' },
  HEO_HERO_CATEGORY_3: { title: '网赚项目', url: '/tag/网赚项目' },
  ...
  HEO_INFO_CARD_URL2: 'https://github.com/gpt123',
  HEO_INFO_CARD_ICON2: 'fab fa-github',
  HEO_INFO_CARD_URL3: 'https://gpt123.eu.org',
  ...
  HEO_SOCIAL_CARD_URL: 'https://group.gpt123.eu.org',
